...
void forgeParserInitialize() {
  ...
  static const int32_t serializedATNSegment[] = {
  	...
  	6,5,5,0,0,6,7,3,0,0,0,7,8,5,6,0,0,8,12,1,0,0,0,9,12,5,8,0,0,10,12,5,7,
...
ForgeParser::ExprContext* ForgeParser::expr(int precedence) {
  ...
  size_t startState = 0;
  enterRecursionRule(_localctx, 0, ForgeParser::RuleExpr, precedence);
    ...
    while (alt != 2 && alt != atn::ATN::INVALID_ALT_NUMBER) {
      if (alt == 1) {
        ...
        case 1: {
          ...
          setState(14);
          _la = _input->LA(1);
          if (!(_la == ForgeParser::T__1

          || _la == ForgeParser::T__2)) {
        ...
        case 2: {
          ...
          setState(17);
          _la = _input->LA(1);
          if (!(_la == ForgeParser::T__0

          || _la == ForgeParser::T__3)) {
          _errHandler->recoverInline(this);
          }
          else {
            _errHandler->reportMatch(this);
